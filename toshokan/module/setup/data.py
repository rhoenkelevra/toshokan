...
def addBook():
    ...
    cur.executemany(
        "insert into books (isbn, title, author, p_name, p_date, status, d_flag) values(%s, %s, %s, %s, %s, %s, %s)",
        books,
    )
...
def addCustomer():
    ...
    cur.executemany(
        "insert into customer (c_name, c_name_kana, post_code, address, tel, qtybooks) values(%s, %s, %s, %s, %s, %s)",
        customer,
    )
